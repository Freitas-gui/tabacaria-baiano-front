...
// HomepageContent component can be defined here if needed
...
//   const categories = [
//     { name: "Remédios e medicamentos", image: "/placeholder.svg?height=80&width=80" },
//     { name: "Genéricos", image: "/placeholder.svg?height=80&width=80" },
//     { name: "Saúde e bem-estar", image: "/placeholder.svg?height=80&width=80" },
//     { name: "Mamães e bebês", image: "/placeholder.svg?height=80&width=80" },
//     { name: "Dermocosméticos", image: "/placeholder.svg?height=80&width=80" },
//     { name: "Diabetes", image: "/placeholder.svg?height=80&width=80" },
//     { name: "Perfumaria", image: "/placeholder.svg?height=80&width=80" },
//   ]
...
//       keywords: ["creme", "pentear", "elseve", "liso", "sonhos", "cabelo", "hair", "cream"],
//     },
//     {
...
//       keywords: ["paracetamol", "dor", "febre", "comprimido", "analgesico", "pain", "fever"],
//     },
//     {
...
//       keywords: ["ibuprofeno", "anti-inflamatorio", "dor", "comprimido", "analgesico", "inflammation"],
//     },
//     {
...
//       keywords: ["oscillococcinum", "homeopatico", "gripe", "resfriado", "flu", "cold"],
//     },
//     {
...
//       keywords: ["dorflex", "dor", "muscular", "relaxante", "muscle", "pain", "sanofi"],
//     },
//     {
...
//       keywords: ["whey", "protein", "proteina", "suplemento", "musculacao", "fitness", "workout"],
//     },
//     {
//       id: "oleo-coco-500ml",
...
//       keywords: ["oleo", "coco", "coconut", "oil", "natural", "virgem", "culinario"],
//     },
//     {
...
//       keywords: ["fralda", "pampers", "bebe", "recem-nascido", "diaper", "baby", "newborn"],
//     },
//     {
...
//       keywords: ["shampoo", "johnsons", "baby", "bebe", "cabelo", "hair", "crianca"],
//     },
//     {
...
//       keywords: ["protetor", "solar", "fps", "la roche posay", "sun", "screen", "dermatologico"],
//     },
//     {
...
//       keywords: ["serum", "vitamina", "c", "the ordinary", "skincare", "antioxidante", "facial"],
//     },
//     {
...
//       keywords: ["glicosimetro", "accu-chek", "diabetes", "glicose", "glucose", "meter", "teste"],
//     },
//     {
...
//       keywords: ["tiras", "reagentes", "glicemia", "diabetes", "teste", "strips", "glucose"],
//     },
//   ]
...
//             <h2 className="text-lg font-semibold text-theme-primary">Resultados para: "{searchQuery}"</h2>
//           </div>
...
//       {!searchQuery && (
//         <div className="mb-12">
//           <h2 className="text-xl font-semibold text-theme-primary mb-6">Categorias:</h2>
...
//                   selectedCategory === category.name ? "ring-2 ring-blue-500 bg-theme-primary" : "hover:bg-gray-50"
//                 }`}
...
//                     selectedCategory === category.name ? "text-theme-primary" : "text-gray-700"
//                   }`}
//                 >
//                   {category.name}
//                 </h3>
...
//           <h2 className="text-xl font-semibold text-theme-primary">{getDisplayTitle()}</h2>
...
//               <Card key={index} className="p-4 card-hover transition-shadow border border-gray-200">
...
//                   <div className="text-xl font-bold text-theme-primary">R$ {product.price}</div>
//                   <div className="text-xs text-gray-500">ou R$ {product.originalPrice} no Pix</div>
//                   <div className="text-xs text-theme-secondary">
//                     Oferta de R$ {product.price} ou R$ {product.originalPrice} dependendo da sua região
//                   </div>
//                 </div>
...
//             </p>
//             {searchQuery && (
//               <Button onClick={handleShowAllProducts} className="btn-theme-primary">
